    ...
    <div className="min-h-screen bg-background">
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Universal Clock</h1>
          <p className="text-muted-foreground">Real-time display in Standard and Seximal time systems</p>
        </div>
